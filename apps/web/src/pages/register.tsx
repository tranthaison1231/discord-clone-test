...
export default function Component() {
  return (
    ...
    <div className="wrapper w-full h-full z-10 absolute  min-h-580 flex justify-center items-center">
      <form className=" flex gap-8 z-10 justify-between shadow-md bg-primary/80 rounded px-8 pt-6 pb-8 mb-4">
        <div className="flex-1">
          ...
          <label
            ...
            <input
              className="shadow bg-primary appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
              id="password"
              type="password"
              placeholder="******************"
            />
