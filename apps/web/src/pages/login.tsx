...
export default function Component() {
  return (
    <div>
      <svg
        className="artwork__8fc92 z-1 absolute"
      ...
      <div className="wrapper w-full h-full z-10 absolute  min-h-580 flex justify-center items-center">
        <form className=" flex gap-8 z-10 justify-between shadow-md bg-primary rounded px-8 pt-6 pb-8 mb-4">
          <div className="flex-1">
            <h1 className="text-white text-lg items-center justify-center flex font-semibold mb-4  ">
              Welcome back!
            </h1>
            <div className="mb-4">
              <label
                className="block uppercase text-white/70 text-sm font-bold mb-2"
                htmlFor="username"
              >
            ...
            <div className="mb-6">
              <label
                className="block text-white/70 uppercase text-sm font-bold mb-2"
                htmlFor="password"
              >
                Password
              </label>
              ...
              />
              <a
                className="inline-block capitalize align-baseline font-bold text-sm text-blue-500 hovers:text-blue-800"
                href="#"
              >
          ...
          <div className="flex-1 flex-col max-w-xs">
            <div className="qr-code ">
              <div className="qrCodeOverlay__3e991">
                <img
                  src="https://discord.com/assets/adf75861421c2a6a6269.png"
                  alt=""
                />
              </div>
            </div>
            ...
            <p className=" text-white/50 align-baseline font-bold text-sm">
              Scan this with the Discord mobile app to log in instanstly
            </p>
          </div>
        </form>
      </div>
